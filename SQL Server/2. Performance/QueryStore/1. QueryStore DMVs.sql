...
-- See if it is using Querystore

Select is_forced_plan, * from sys.query_store_plan

Select count(*) '#Forced Plan failed attempts', query_plan_hash
from sys.query_store_plan
where force_failure_count = 1
group by query_plan_hash

Select count(*) '#Forced Plan', query_plan_hash
from sys.query_store_plan
...
from sys.query_store_plan
Where Query_plan_hash = 0x1519187E397EDC4C