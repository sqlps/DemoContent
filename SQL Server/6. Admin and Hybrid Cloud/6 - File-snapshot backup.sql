...
BACKUP DATABASE AdventureworksDW_Azure 
TO URL = 'https://pankajtsp.blob.core.windows.net/sqlbackups/AdventureworksDW2008_AzureSnapTest10.bak' 
...
Print @Log_FileName
go
-- AdventureworksDW_Azure_Log_2017_03_08_17_13_25.trn
-- ============================================================================================================
-- Step 4) Record the current time
-- ============================================================================================================
select getdate()

--2017-03-08 17:13:40.120
...
FROM URL = 'https://pankajtsp.blob.core.windows.net/sqlbackups/AdventureworksDW_Azure_Log_2017_03_08_17_13_25.trn' 
WITH RECOVERY, REPLACE
,STOPAT = '2017-03-08 17:13:40.120';
Restore Database AdventureworksDW_Azure with recovery
GO
/*
RESTORE DATABASE AdventureworksDW_Azure
FROM URL = 'https://pankajtsp.blob.core.windows.net/sqlbackups/AdventureworksDW2008_AzureSnapTest2.bak' 
WITH RECOVERY, REPLACE
*/
