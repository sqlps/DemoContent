...
$arguments = "-Q""LoadTest.usp_InsertWorkload 'RowsInserted-Basic'"" -S""$BaselineServer"" -d$BaselineDB -U$Login -P$pwd -t$ostressquerytimeout -o""RowsInserted-Basic"" -q -n$BaselineThreads -r$BaselineRuns"
Start-Process -FilePath "$program" -ArgumentList "$arguments"

$program = "C:\Program Files\Microsoft Corporation\RMLUtils\ostress.exe"
$arguments = "-Q""LoadTest.usp_InsertWorkload 'RowsInserted-Premium'"" -S""$CompareServer"" -d$CompareDB -U$Login -P$pwd -t$ostressquerytimeout -o""RowsInserted-Premium"" -q -n$CompareThreads -r$CompareRuns"
Start-Process -FilePath "$program" -ArgumentList "$arguments"
...
{
    # Read Load Test Data
    $Results1 = Invoke-Sqlcmd -ServerInstance $BaselineServer -Database $BaselineDB -Username $Login -Password $pwd -Query "exec LoadTest.usp_GetPerfMetrics 'RowsInserted-Basic'"
    $Results2 = Invoke-Sqlcmd -ServerInstance $CompareServer  -Database $CompareDB -Username $Login -Password $pwd -Query "exec LoadTest.usp_GetPerfMetrics 'RowsInserted-Premium'"
