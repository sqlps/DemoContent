...
$arguments = "-Q""LoadTest.usp_ReadWorkLoad 'ReadWorkload-Basic'"" -S""$BaselineServer"" -d$BaselineDB -U$Login -P$pwd -$ostressquerytimeout -o""ReadWorkload-Basic"" -q -n$BaselineThreads -r$BaselineRuns"
Start-Process -FilePath "$program" -ArgumentList "$arguments"

$program = "C:\Program Files\Microsoft Corporation\RMLUtils\ostress.exe"
$arguments = "-Q""LoadTest.usp_ReadWorkLoad 'ReadWorkload-Premium'"" -S""$CompareServer"" -d$CompareDB -U$Login -P$pwd -$ostressquerytimeout -o""ReadWorkload-Premium"" -q -n$CompareThreads -r$CompareRuns"
Start-Process -FilePath "$program" -ArgumentList "$arguments"
