...
Select @MaxEndTime = Max(End_time) from sys.dm_db_resource_stats
select 	@ResourceStatsTime =end_time,
...
Select @TestScenario As 'TestScenario', @CollectionTime As 'CollectionTime' , @CurrentExecutionCount As 'CurrentExecutionCount' ,  @BatchRequests As 'Batch_Requests_per_sec' , @connections As 'Connections' ,
		@ResourceStatsTime as 'dm_db_resource_stats__end_time' , @avg_cpu_percent as 'Avg_cpu_percent' , @avg_data_io_percent as 'Avg_data_io_percent' , 
		@avg_log_write_percent as 'Avg_log_write_percent' , @avg_memory_usage_percent as 'Avg_memory_usage_percent', @RunMessage as 'RunMessage'
GO
