...
$Blobname = 'Adventureworks2014_Premium_v2.bacpac'
...
$ServiceObjective = Get-AzureSQLDatabaseServiceObjective $ServerName -ServiceObjectiveName 'S1'
$database = New-AzureSqlDatabase -ServerName $server.ServerName -DatabaseName $DatabaseName -Edition "Standard" -MaxSizeGB 1 -ServiceObjective $ServiceObjective
