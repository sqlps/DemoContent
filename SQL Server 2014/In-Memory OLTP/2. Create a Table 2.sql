 ...
 * TALKING POINTS *
 ******************
 1) Requires at least one index, for durable tables it must have a PK
 ...
 6) Creating a table will create a DLL that includes the functions for accessing indexes and retrieving data from the table */
...
-- Browse to D:\SQL\MSSQL11.MSSQLSERVER\MSSQL\DATA\xtp
