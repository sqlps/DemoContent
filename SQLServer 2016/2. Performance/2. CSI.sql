...
-- CSI in this case is 25% smaller than the data size from page compressed
...
PRINT '
	   ...
	   ****************************************
       * Using page compressed table: ' + CAST(DATEDIFF(millisecond, @StartingTime, SYSDATETIME()) AS varchar(20)) + ' ms *
	   ****************************************';
...
PRINT '
	   ...
	   *********************************************
       * Using Clustered Column Store Index: ' + CAST(DATEDIFF(millisecond, @StartingTime, SYSDATETIME()) AS varchar(20)) + ' ms *
	   *********************************************';
...
-- =====================================================================================================
-- Step 4) Batch  Mode improvements under compatibility mode 130
-- =====================================================================================================
...
/*************************************************************************************
STOP!!!! STEP 10 - Diagnostics and DMVs
**********************************************************************************/
-- New DMV
