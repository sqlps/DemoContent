...
ALTER DATABASE [QueryStoreTest] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, MAX_STORAGE_SIZE_MB = 10)
...
--At this point we could change to AUTO where infrequent queries and queries with insignificant compile and execution duration are ignored. 
