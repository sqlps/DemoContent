...
#Invoke-Sqlcmd -ServerInstance $ServerInstance -Database $DBName -Query "ALTER DATABASE [Adventureworks2016CTP3] SET QUERY_STORE = ON"
#Invoke-Sqlcmd -ServerInstance $ServerInstance -Database $DBName -Query "ALTER DATABASE [Adventureworks2016CTP3] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 367), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 1, MAX_STORAGE_SIZE_MB = 100, QUERY_CAPTURE_MODE = ALL, SIZE_BASED_CLEANUP_MODE = OFF)"
